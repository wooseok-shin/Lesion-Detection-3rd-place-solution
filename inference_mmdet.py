...
parser.add_argument('--checkpoint', default='epoch_22',help='model_weight')
...
if __name__ == '__main__':
    os.makedirs('mmdetection/work_dirs/', exist_ok=True)
    checkpoint = os.path.join('mmdetection/work_dirs', f'{args.exp_name}', f'{args.checkpoint}.pth')
